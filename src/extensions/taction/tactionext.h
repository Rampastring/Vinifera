...
private:
    ...
    static bool Do_CREATE_BUILDING_AT(TActionClass& taction, HouseClass* house, ObjectClass* object, TriggerClass* trig, const Cell& cell);
    ...
    static bool Do_APPLY_IRON_CURTAIN(TActionClass& taction, HouseClass* house, ObjectClass* object, TriggerClass* trig, const Cell& cell);
