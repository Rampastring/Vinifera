...
void BuildingClassExt::_Update_Buildables()
{
    if (House == PlayerPtr && !IsInLimbo && IsDiscoveredByPlayer && IsPowerOn)
    {
        ...
        case RTTI_AIRCRAFTTYPE:
            ...
            {
                if (PlayerPtr->Can_Build(AircraftTypes[i], false, true) && AircraftTypes[i]->Who_Can_Build_Me(true, false, true, PlayerPtr) != nullptr)
                {
        ...
        case RTTI_BUILDINGTYPE:
            ...
            {
                if (PlayerPtr->Can_Build(BuildingTypes[i], false, true) && BuildingTypes[i]->Who_Can_Build_Me(true, false, true, PlayerPtr) != nullptr)
                {
        ...
        case RTTI_INFANTRYTYPE:
            ...
            {
                if (PlayerPtr->Can_Build(InfantryTypes[i], false, true) && InfantryTypes[i]->Who_Can_Build_Me(true, false, true, PlayerPtr) != nullptr)
                {
        ...
        case RTTI_UNITTYPE:
            ...
            {
                if (PlayerPtr->Can_Build(UnitTypes[i], false, true) && UnitTypes[i]->Who_Can_Build_Me(true, false, true, PlayerPtr) != nullptr)
                {
